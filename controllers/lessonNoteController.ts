...
export const getLessonNotes = async (req: CustomRequest, res: Response, next: NextFunction) => {
    try {
...
export const getLessonNoteById = async (req: CustomRequest, res: Response, next: NextFunction) => {
    try {
...
export const updateLessonNote = async (req: CustomRequest, res: Response, next: NextFunction) => {
    try {
